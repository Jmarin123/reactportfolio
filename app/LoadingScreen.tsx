...
const LoadingScreen = () => {
    ...
    return (
        <div className={`fixed top-0 left-0 w-full h-full bg-dark-background flex justify-center items-center text-white`}>
            {/* ${isFadeOut ? "opacity-0 transition-opacity duration-500 ease-in-out" : ""} */}
