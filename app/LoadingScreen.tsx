...
const LoadingScreen = () => {
    ...
    return (
        <div className={`fixed top-0 left-0 w-full h-full bg-dark-background bg-opacity-80 flex justify-center items-center text-white z-50 ${isFadeOut ? "opacity-0 transition-opacity duration-500 ease-in-out" : ""}`}>
